              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="<?php echo'../../'.$_SESSION['adminImg']?>" alt="User Avatar">
                    <span class="d-none d-md-inline-block"><?php echo $_SESSION['adminName']?></span>
                  </a>
                ...
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto">
                      <img class="rounded-circle" src="<?php echo'../../'.$_SESSION['adminImg']?>" alt="User Avatar" width="110"> </div>
                    <h4 class="mb-0"><?php echo $_SESSION['adminName']?></h4>
                    <span class="text-muted d-block mb-2"><?php if($_SESSION['adminGroup']==1) echo 'مدير';?></span>
                    <button type="button" class="mb-2 btn btn-sm btn-pill btn-outline-primary mr-2">
                        <i class="material-icons mr-1">logout</i><a href="logout.php">تسجيل الخروج</a></button>
                  </div>
                          ...
                          <form>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feFirstName">الاسم</label>
