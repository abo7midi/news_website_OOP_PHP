            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        <h3 class="page-title">إضافة خبر عاجل</h3>
                    </div>
                </div>
                <!-- End Page Header -->
                <div class="row">
                            ...
                            <div class="card-body">
                                <form class="add-new-post" method="post" action="../validation.php" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="ahmed">محتوى الخبر</label>
                                        <textarea id="ahmed" name="breakContent"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="ex">فترة ظهور الخبر بالساعة </label>
                                        <input type="number"  min="1" max="24" placeholder="أعلى قيمة هي 24 ساعة" id="ex" name="breakEX" class="form-control form-control-lg mb-3"></input>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary form-control form-control-lg mb-3" name="breakBtn">نشر
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="row">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">وقت النشر</th>
                                    <th scope="col">فترة الظهور</th>
                                ...
                                $counts=1;
                                $publisher="";
                                foreach($break->getAllBreaks() as $brk){
                                    if($brk["user_id"]==$_SESSION["adminId"]){
                                        $publisher="me";
                                    }else{
                                        $publisher=$brk["user_name"];
                                    }

                                    echo' <tr>
                                  <th scope="row">'.$counts.'</th>
                                  <td>'.$brk['break_content'].'</td>
                                  <td>'.$publisher.'</td>
                                  <td>'.$brk['break_date'].'</td>
                                  <td>'.$brk['break_duration_min'].'</td>';
                                        if($brk['break_state']=="1"){
                                            echo'<td ><a type="button" href="../validation.php?brkID='.$brk['break_id'].' && brkState=0" class="btn btn-danger" id="off">تعطيل</a><input type="hidden" value="'.$brk['break_id'].'" id="brkId"></td>';
                                        }else{
                                            echo'<td><a type="button" href="../validation.php?brkID='.$brk['break_id'].' && brkState=1" class="btn btn-success" id="on">تنشيط</a><input type="hidden" value="'.$brk['break_id'].'" id="brkId"></td>';
                                        }
                                        echo'</tr>';
                                        $counts++;
                                }
