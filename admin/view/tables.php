                  ...
                  <div class="card-body">
                      <form class="add-new-post" method="post" action="" enctype="multipart/form-data">
                          <div class="form-group">
                              <label for="exampleFormControlSelect1"> المستخدمين</label>
                              <select class="form-control" name='userState' id="exampleFormControlSelect1">
                                  <option class='form-control form-control-lg mb-3' value="getAllUsers">الكل</option>
                                  <option class='form-control form-control-lg mb-3' value="getunacceptedUsers">الموقوفين</option>
                                  <option class='form-control form-control-lg mb-3' value="getAcceptedUsers">النشطين</option>
                              </select>
                          </div>
                          <button type="submit" class="btn btn-primary form-control form-control-lg mb-3" name="getUsers">عرض
                          </button>
                  ...
                  <div class="card-body p-0 pb-3 text-center">
                      <table class="table mb-0">
                          ...
                          <tr>
                              ...
                              <th scope="col" class="border-bottom-0">اسم المستخدم</th>
                              <th scope="col" class="border-bottom-0">تأريخ التسجيل</th>
                              <th scope="col" class="border-bottom-0">البريد الالكتروني</th>
                              <th scope="col" class="border-bottom-0">رتبة المستخدم</th>
                              <th scope="col" class="border-bottom-0">حالة المستخدم</th>
                          </tr>
                          </thead>
                          <tbody>
                         <?php
                         ...
                         if(isset($_POST['getUsers'])){
                             switch($_POST['userState']){
                                 case "getAllUsers":$getuser=$user->getAllUsers();break;
                                 case "getunacceptedUsers":$getuser=$user->getUnacceptedUsers();break;
                                 case "getAcceptedUsers":$getuser=$user->getAcceptedUsers();break;
                             }
                         }
                            $count=1;
                            $group="";
                            foreach ($getuser as $row){
                                ...
                                echo "<tr>
                                      ...
                                      <td>$group</td>";
                                if($row["user_state"]==1)
                                      echo'<td><a type="button" href="../validation.php?userID='.$row['user_id'].' && userState=0" class="btn btn-danger" id="off">توقيف</a><input type="hidden" value="'.$row['user_id'].'" id="userId"></td>';
                                else
                                    echo'<td><a type="button" href="../validation.php?userID='.$row['user_id'].' && userState=1" class="btn btn-success" id="on">تفعيل</a><input type="hidden" value="'.$row['user_id'].'" id="userId"></td>';
                                echo"</tr>";
                                $count++;
                            }
                         ?>
