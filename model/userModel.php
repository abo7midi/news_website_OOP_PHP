<?php
class UserModel{
    static $login="SELECT * FROM users where user_email=:email and user_pass=:pass  and user_group_id=2 and user_state=1" ;
    ...
    static $rigestrUser="insert into users values(null,:uname,:upass,:uemail,:usex,2,:uimg,0,now())" ;
