...
class Articals extends DB {
    ...
    function getlastArticals(){
        return $this->select(ArticalModel::$getlastArticals);
    }

    function getCateArticals($catid){
        $info=array('catid'=>$catid);
        return $this->select(ArticalModel::$getCateArticals,$info);
    }
